...
static const char *colors[][2] =
    ...
    {
        /*               fg         bg       */
        [SchemeNorm] = {"#9DDDCB", "#282e3a"},
        [SchemeSel] = {"#F0AFE1", "#282e3a"},
        [SchemeOut] = {"#000000", "#282e3a"},
#if MORECOLOR_PATCH
        [SchemeMid] = {"#ECBFBD", "#770000"},
#endif // MORECOLOR_PATCH
#if HIGHLIGHT_PATCH || FUZZYHIGHLIGHT_PATCH
        [SchemeSelHighlight] = {"#C6AAE8", "#282e3a"},
        [SchemeNormHighlight] = {"#A4B9EF", "#282e3a"},
